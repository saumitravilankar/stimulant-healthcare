...
import Footer from '@/components/dark/asymmetric-portfolio/Footer';
import Navbar from '@/components/dark/asymmetric-portfolio/Navbar';
import Portfolio from '@/components/dark/asymmetric-portfolio/Portfolio';
...
export default function AsymmetricPorfolio() {
  return (
    <body>
      <LoadingScreen />
      <Cursor />
