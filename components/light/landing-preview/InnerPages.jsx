      ...
      <div className="container">
        ...
        <div className="swiper3">
          ...
          >
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-about" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-about2" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-about3" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-services" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-services2" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-services-details" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-contact" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-contact2" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-contact3" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-team" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-team-single" target="_blank">
            ...
            <SwiperSlide>
              <div className="item">
                <a href="/light/page-FAQS" target="_blank">
